        ...
        >
          ...
          <div className="max-w-2xl mx-auto relative">
            ...
            <Input
              ...
              className="w-full pl-12 py-6 text-lg bg-white/10 border-white/20 text-white placeholder:text-blue-200 focus-visible:ring-offset-0 focus-visible:ring-[#3B82F6] rounded-xl backdrop-blur-sm"
              value={searchQuery}
